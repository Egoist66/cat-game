    ...
    <div v-if="modalStore.showGuide" class="guide-overlay" @click.self="modalStore.closeGuide">
      <div class="guide-modal">
        ...
        <div class="guide-content">
          <section>
            <h3>🐱 О котике</h3>
            <p>У твоего котика есть три показателя: <b>🍖 Сытость</b>, <b>😸 Счастье</b> и <b>💧 Жажда</b>. Также есть <b>⚖️ Вес</b>.</p>
            ...
            <ul>
              ...
              <li><b>💧 Жажда</b> — падает на 0.2/сек. Если ниже 15% — котик просит пить.</li>
              <li>Если все показатели выше 80/60/50 — котик в экстазе и приносит больше мурчалок!</li>
              <li><b>⚖️ Вес</b> — меняется в зависимости от сытости: растёт если сытость > 70%, падает если < 30%.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>Попробуй сказать: <b>"кушать"</b>, <b>"люблю"</b>, <b>"играть"</b>, <b>"спать"</b>, <b>"красивый"</b>, <b>"глупый"</b>, <b>"не буду"</b> или <b>"посол от сюда"</b>.</p>
          ...
          <section>
            ...
            <ul>
              ...
              <li><b>💧 Водички</b> — +30 к жажде, котик напивается 😻</li>
              ...
              <li><b>🎲 Случайные события</b> — пока котик без дела, с ним случаются забавные вещи, меняющие счастье</li>
            </ul>
          </section>
